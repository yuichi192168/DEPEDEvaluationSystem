...
$ppstIndicators = [
    [
        ...
        "items" => [
            ["code" => "1.1.2", "text" => "Apply knowledge of content within and across curriculum teaching areas."],
            ["code" => "1.2.2", "text" => "Use research-based knowledge and principles of teaching and learning to enhance professional practice."],
            ["code" => "1.3.2", "text" => "Ensure the positive use of ICT to facilitate the teaching and learning process."],
            ["code" => "1.4.2", "text" => "Use a range of teaching strategies that enhance learner achievement in literacy and numeracy skills."],
            ["code" => "1.5.2", "text" => "Apply a range of teaching strategies to develop critical and creative thinking, as well as other higher-order thinking skills."],
            ["code" => "1.6.2", "text" => "Display proficient use of Mother Tongue, Filipino and English to facilitate teaching and learning."],
            ["code" => "1.7.2", "text" => "Use effective verbal and non-verbal classroom communication strategies to support learner understanding, participation, engagement and achievement."],
        ],
    ],
    [
        "domain" => "Domain 2. Learning Environment",
        "items" => [
            ["code" => "2.1.2", "text" => "Establish safe and secure learning environments to enhance learning through consistent implementation of policies, guidelines and procedures."],
            ["code" => "2.2.2", "text" => "Maintain learning environments that promote fairness, respect and care to encourage learning."],
            ["code" => "2.3.2", "text" => "Manage classroom structure to engage learners, individually or in groups, in meaningful exploration, discovery and hands-on activities within a range of physical learning environments."],
            ["code" => "2.4.2", "text" => "Maintain supportive learning environments that nurture and inspire learners to participate, cooperate and collaborate in continued learning."],
            ["code" => "2.5.2", "text" => "Apply a range of successful strategies that maintain learning environments that motivate learners to work productively by assuming responsibility for their own learning."],
            ["code" => "2.6.2", "text" => "Manage learner behavior constructively by applying positive and non-violent discipline to ensure learning-focused environments."],
        ],
    ],
    [
        "domain" => "Domain 3. Diversity of Learners",
        "items" => [
            ["code" => "3.1.2", "text" => "Use differentiated, developmentally appropriate learning experiences to address learners' gender, needs, strengths, interests and experiences."],
            ["code" => "3.2.2", "text" => "Establish a learner-centered culture by using teaching strategies that respond to learners' linguistic, cultural, socio-economic and religious backgrounds."],
            ["code" => "3.3.2", "text" => "Design, adapt and implement teaching strategies that are responsive to learners with disabilities, giftedness and talents."],
            ["code" => "3.4.2", "text" => "Plan and deliver teaching strategies that are responsive to the special educational needs of learners in difficult circumstances, including geographic isolation, chronic illness; displacement due to armed conflict, urban resettlement or disasters; child abuse and child labor practices."],
            ["code" => "3.5.2", "text" => "Adapt and use culturally appropriate teaching strategies to address the needs of learners from indigenous groups."],
        ],
    ],
    [
        "domain" => "Domain 4. Curriculum and Planning",
        "items" => [
            ["code" => "4.1.2", "text" => "Plan, manage and implement developmentally sequenced teaching and learning process to meet curriculum requirements and varied teaching contexts."],
            ["code" => "4.2.2", "text" => "Set achievable and appropriate learning outcomes that are aligned with learning competencies."],
            ["code" => "4.3.2", "text" => "Adapt and implement learning programs that ensure relevance and responsiveness to the needs of all learners."],
            ["code" => "4.4.2", "text" => "Participate in collegial discussions that use teacher and learner feedback to enrich teaching practice."],
            ["code" => "4.5.2", "text" => "Select, develop, organize and use appropriate teaching and learning resources, including ICT, to address learning goals."],
        ],
    ],
    [
        "domain" => "Domain 5. Assessment and Reporting",
        "items" => [
            ["code" => "5.1.2", "text" => "Design, select, organize and use diagnostic, formative, and summative assessment strategies consistent with curriculum requirements."],
            ["code" => "5.2.2", "text" => "Monitor and evaluate learner progress and achievement using learner attainment data."],
            ["code" => "5.3.2", "text" => "Use strategies for providing timely, accurate and constructive feedback to improve learner performance."],
            ["code" => "5.4.2", "text" => "Communicate promptly and clearly the learners' needs, progress and achievement to key stakeholders, including parents/guardians."],
            ["code" => "5.5.2", "text" => "Utilize assessment data to inform the modification of teaching and learning practices and programs."],
        ],
    ],
    [
        "domain" => "Domain 6. Community Linkages and Professional Engagement",
        "items" => [
            ["code" => "6.1.2", "text" => "Maintain learning environments that are responsive to community contexts."],
            ["code" => "6.2.2", "text" => "Build relationships with parents/guardians and the wider school community to facilitate involvement in the educative process."],
            ["code" => "6.3.2", "text" => "Review regularly personal teaching practice using existing laws and regulations that apply to the teaching profession and the responsibilities specified in the Code of Ethics for Professional Teachers."],
            ["code" => "6.4.2", "text" => "Comply with and implement school policies and procedures consistently to foster harmonious relationships with learners, parents, and other stakeholders."],
        ],
    ],
    [
        "domain" => "Domain 7. Personal Growth and Professional Development",
        "items" => [
            ["code" => "7.1.2", "text" => "Apply a personal philosophy of teaching that is learner-centered."],
            ["code" => "7.2.2", "text" => "Adopt practices that uphold the dignity of teaching as a profession by exhibiting qualities such as caring attitude, respect and integrity."],
            ["code" => "7.3.2", "text" => "Participate in professional networks to share knowledge and to enhance practice."],
            ["code" => "7.4.2", "text" => "Develop a personal professional improvement plan based on reflection of one's practice and ongoing professional learning."],
            ["code" => "7.5.2", "text" => "Set professional development goals based on the Philippine Professional Standards for Teachers."],
        ],
    ],
];
